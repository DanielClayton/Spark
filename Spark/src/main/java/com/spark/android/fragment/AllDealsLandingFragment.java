...
public class AllDealsLandingFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ArrayList<String> retailers = new ArrayList<>(getResources().getStringArray(R.array.retailers).length);
        Collections.addAll(retailers, getResources().getStringArray(R.array.retailers));
        Collections.sort(retailers);

        ArrayAdapter<String> adapter = new RetailersAdapter(getActivity(), R.layout.category_item, retailers);
